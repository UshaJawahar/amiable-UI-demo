  ...
  const features = [
    {
      ...
      description: "Curated profiles of skilled individuals with disabilities, verified through our comprehensive screening process."
    },
    {
        ...
        <div className="container-max text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
              Connect talented individuals with disabilities to opportunities in film, television, and OTT industries. 
        ...
        <div className="container-max">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide a comprehensive ecosystem designed specifically for the unique needs of disabled talent 
              and industry professionals seeking inclusive hiring solutions.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Empowering disabled talent in the media industry through inclusive opportunities and professional connections.
              </p>
            </div>
